...
//    // 取得成功時のLiveData
//    @NonNull
//    private final MutableLiveData<LocationData> _locationResult;
//
//    @NonNull
//    public LiveData<LocationData> getLocationResult() {
...
//                        _locationResult.setValue(new LocationData(lastLocation.getLatitude(), lastLocation.getLongitude()));
